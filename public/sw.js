const CACHE_NAME = "cardcade-shell-v59";
...
const APP_SHELL = [
  ...
  "shared/rotating-rummy-deck.js?v=1",
  "shared/rotating-rummy-routes.js?v=1",
  "shared/rotating-rummy-rules.js?v=1",
