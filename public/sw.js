const CACHE_NAME = "cardcade-shell-v178";
...
const APP_SHELL = [
  ...
  "app.css?v=147",
  "app.js?v=116",
  "expansion-games.js?v=7",
  "expansion-games.css?v=8",
  "shared/trick-rules.js?v=1",
  "shared/juan-fleep-deck.js?v=1",
  "turn-alerts.js?v=2",
  ...
  "shared/card-presentation.js?v=19",
  "shared/controller-input.js?v=3",
  "shared/card-skins.js?v=8",
